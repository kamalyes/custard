...
from custard.swagger import swagger_parse, utils
from custard.time import calc_time
    ...
    def init_env(cls, service):
        ...
        try:
            ...
            with open(file_name, "w", encoding="utf-8") as file:
                ...
                table_header = "|url|method|status_code|headers|params|json|response_text|\n"
                table_style = "|:------:|:------:|:------:|:------:|:------:|:------:|:------:|\n"
