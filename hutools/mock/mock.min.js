!(function (t, e) {
    ...
    return (function (t) {
	    ...
	    Mock - 模拟请求 & 模拟数据
	    https://github.com/kamalyes/mockjs
	*/
            var s = {
                Handler: a,
                Random: u,
            ...
            t.exports = {
                parse: function (t) {
                    ...
                    var e = (t || "").match(r.RE_KEY),
                        ...
                        h = l
                            ? (!l[2] && parseInt(l[1], 10)) || a.integer(c, s)
                            : void 0,
                        p = {
                            parameters: e,
                            range: n,
            ...
            var a = n(2),
                ...
                i = {
                    ...
                    type: function (t, e, n, r) {
                        ...
                        switch (t.type) {
                            case "string":
                                if (t.template.match(a.RE_PLACEHOLDER))
                                    return !0;
                                break;
                            case "array":
                                if (t.rule.parameters) {
                        ...
                        return (
                            l.equal("type", t.path, o.type(e), t.type, r),
                            r.length === u
                        );
                    },
                    value: function (t, e, n, r) {
                        var o = r.length,
                            u = t.rule,
                            i = t.type;
                        if ("object" === i || "array" === i || "function" === i)
                            return !0;
                        if (!u.parameters) {
                            switch (i) {
                                case "regexp":
                            ...
                            return (
                                l.equal("value", t.path, e, t.template, r),
                                r.length === o
                            );
                        }
                        var c;
